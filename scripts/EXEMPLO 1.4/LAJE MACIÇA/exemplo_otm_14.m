% -----------------------------------------
% NOME DO ARQUIVO: exemplo_otm_24.m
...
% DADOS DE ENTRADA
% ---
% chamando a função dados_exemplo_24
...
% ESTIMATIVA INICIAL
% ---
x0 = [0.13 ;4 ;4;0.03 ;0.03]; %chute inicial
%                                           lx
...
[x,FunVal,ExitFlag,Output]=... 
    fmincon('exemplo_objf_14',x0,Aeq,beq,A,b,Lb,Ub,'exemplo_nolinear_constrains_14',options);
