% -----------------------------------------
% NOME DO ARQUIVO: exemplo_otm_13.m
...
% DADOS DE ENTRADA
% ---
% chamando a função dados_exemplo_13
...
% x3 = xposx altura da linha neutra em metros
altmin = 0.07;
...
Lb = [altmin; 0;0]; %limite inferior
Ub =[Inf; Inf; Inf]; %limite superior

% ---
% ESTIMATIVA INICIAL
% ---
x0 = [0.13 ;4 ;0.03]; %chute inicial
%                                           lx
...
[x,FunVal,ExitFlag,Output]=... 
    fmincon('exemplo_objf_12',x0,Aeq,beq,A,b,Lb,Ub,'exemplo_nolinear_constrains_12',options);
...
disp('-------------------------------- ')
disp(['Linha neutra (x4) (m) = ' num2str(x(3))])
disp('-------------------------------- ')
